					...
					if(data.chapter[chapterId].lessonIds){
						data.chapter[chapterId].lessonIds.forEach(function(lessonId){
							...
							switch(data.lesson[lessonId].dateStatus){
								case "expiringAsap":
									var scarcityHtml = `<p class="materialOutlineExpire"><i class="fa fa-unlock"></i>Expiring in <span data-countdown="${data.lesson[lessonId].deadlineDateString}"><span data-days>00</span><span data-days-caption> Days </span><span data-hours>00</span>:<span data-minutes >00</span>:<span data-seconds>00</span></span></p>`;
									break;
								case "expiringSoon":
									var scarcityHtml = `<p class="materialOutlineExpire"><i class="fa fa-unlock"></i>Expiring Soon</p>`;  
									break;
								case "comingAsap":
								...
								case "comingSoon":
									...
									break;
								case "expired":
									var scarcityHtml = `<p class="materialOutlineExpire"><i class="fa fa-lock"></i>Locked</p>`;  
									break;	
								case "available": 
								default: 
									var scarcityHtml = "";
