								...
								<div>
									<div class="iconDiv">
										<div class="materialCardProgressLeft">
											<div class="materialProgressCircle materialThemeGoldDark" data-progress="50" data-progress-affects-data-percentage>
									...
									<div class="contentDiv">
										<h4>You have ${data.user.stats.lessons.complete}/${data.user.stats.lessons.total}</h4>
										<p class="paddingTop7">Lessons Completed ${data.user.stats.lessons.total - data.user.stats.lessons.complete} unfinished lessons.</p>
									</div>
								</div>
