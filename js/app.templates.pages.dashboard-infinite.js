...
app.templates.pages.dashboardInfiniteScrolling = {
	...
	//Create rewards Sections
		...
		var html = ` 
			...
			<div class="container">
				<div class="row action-cards-top" data-target='topCards'>  
					...
					<div class="container"> 
						<div class="row">
								...
								<div class="row marginTop15">
									<div class="col-sm-12">
										<div class="infiniteScrollingCardsSearchBar" style=""> 
											<input placeholder="${config.text.searchBarPlaceholder}"  data-target='searchInput' class="materialInputTextArea materialThemeDark" type="text"> 
										</div>
										<div class=""> 
											<button class="materialButtonFill materialThemeDark searchBtn" data-target='searchButton' ><i class="fa fa-search"></i> Search</button>
										</div>
									</div>
								</div>
							</div>	
							...
							<div class="container-fluid container-fluid-max-width">
								<div class="row">
									<div class="col-sm-12 marginTop5 marginBottom3">
										<button class="materialButtonText materialThemeDark filterSwitch" data-target='filterButton'><i class="fa fa-filter"></i> FILTER</button>
									</div>
								</div>
								
								<div class="row filterDropdownToggle marginBottom3" data-target='filterSection'>
									 <!-- Created dynamically -->
								</div>
							...
							<div class="container-fluid container-fluid-max-width">
								...
								<div class="row infiniteScrollingContainer" data-target='infiniteScrollingCards'> 
