                            ...
                            <div class="col-xs-12">
                                ...
                                <script>  
                                    ...
                                    window.document.PlyrCallbackEnded = function(vimeoData){
                                        ...
                                        if(thisLesson().engagementProgressRealPercent>95){
                                            materialDialog.show('dialogLessonRating');
                                        }
                                    };
        ...
        var html = `
            <div>
                <div>
                    ...
                    <section class="app_lessonOverviewSection materialLesson ${lessonData.type}">
                        ...
                        <div class="lessonProgress help-lesson-progress-text" style="margin-bottom: 30px;">
