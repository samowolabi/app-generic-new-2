  ...
  sift4Distance: function (s1, s2, maxOffset) {
    ...
    while (c1 < l1 && c2 < l2) {
      if (s1.charAt(c1) == s2.charAt(c2)) {
        local_cs++;
        var isTrans = false; //see if current match is a transposition
      ...
      c1++;
      c2++; // this covers the case where the last match is on the last token in list, so that it can compute transpositions correctly
