materialDialog.alert("+ 50 Reward Points Added", "Great job! You now have a total of: <b>3023 Reward Points</b>! </b><br><br>Gain more Reward Points to get free access to premium piano courses from The Piano Encyclopedia.", {
 buttonCaption: "Continue Learning",
    theme: "materialButtonFill materialThemeDark"
})
    materialDialog.alert("Your answer is correct!", "Well done! It's a <i>C Major Chord</i>. <br><b>Congratulations, you will now be awarded 50 Reward Points!</b><br><img style='width: 100%' src='https://learn.pianoencyclopedia.com/hydra/pianos/sffffff/680/XOVERRIDEC-E-G@_C-_E-_GX/2/YY/What%27s+the+name+of+this+chord%3F-Xaebd86-X600.gif'>", {
 buttonCaption: "Collect your Reward!",
    theme: "materialButtonFill materialThemeDark"
});
...
dialogRewardPointsAdded.init = function(thisComponent) {
    ...
    var rewardPoints = 60000;
    thisComponent.html(`
	<h3>${header}</h3>
	<div class="materialDialogContent"> 
		<div>
			<div class="materialProgressCircle" data-percentage="95" data-progress="95">
				...
				<div class="materialProgressCircle-value">
					<div>
						<span><span>${rewardPoints}</span></span><br>
						REWARD POINTS
					</div>
				</div>
			</div>
		...
		<div style="text-align: center; margin-top: 30px;">
			<h3 class="materialHeader">${rewardPoints} REWARD POINTS ADDED!</h3>
			<p class="materialParagraph"><b>You are almost there!</b> Gain more Reward Points to get free access to premium piano courses from The Piano Encyclopedia.</p>
		</div> 
	</div>
	<div class="materialDialogAction">
		<a class="materialButtonFill materialThemeDark" data-value="OK" href="#">Continue Learning</a>
	</div>
	`);
};
...
var dialogUnlockLesson = function(){
	...
	app.data.user.offer = app.data.user.offer || {};
	app.data.user.offer.unlockDialog = app.data.user.offer.unlockDialog || {};
	
	var url 			 = (app.data.user.offer.url || "https://pianoencyclopedia.com/en/piano-courses/the-logic-behind-music/") + "?ref=members-area-unlock";
	var title 		     = app.data.user.offer.unlockDialog.title || "Would you like to unlock this lesson now?";
	var message 		 = app.data.user.offer.unlockDialog.message || "Get unlimited <i>lifetime</i> access to all lessons from the Members-Area and upgrade to a premium account by ordering  our  world-acclaimed Digital-Home Study Course  'The Logic Behind Music'. <br><br><b>Get  ready to make your musical dreams come true with  The Piano Encyclopedia!</b>";
	var buttonNoCaption  = app.data.user.offer.unlockDialog.buttonNoCaption || "Not yet";
	var buttonYesCaption = app.data.user.offer.unlockDialog.buttonYesCaption || "Unlock All";
	
	
	materialDialog.question(title, message,                        
	{
		"buttonNo":{
			caption: buttonNoCaption,
			value: "no"
		},
		"buttonYes":{
			caption: buttonYesCaption,
			href:  url,
